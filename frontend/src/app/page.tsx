          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 max-w-5xl mt-12 w-full mx-auto">
                  ...
                  <div>
                          <div className="flex flex-col">
                                  ...
                                  <div className="mt-4 grid grid-cols-[auto_1fr] gap-3 gap-x-2 text-base font-medium text-white">

                                    <div>Hydro One — </div>
                                    <div>
                                      <span> Data & Analytics </span>
                                      <span className="font-thin italic">(16-month Co-op)</span>
                                    </div>

                                    <div>DARE! Lab — </div>
                                    <div>
                                      <div> Data Science & Bibliometric Research</div>
                                      <div className="font-thin italic">(4-month Co-op; 8-month part-time Research Assistant)</div>
                                    </div>

                                    <div>GNSS Lab — </div>
                                    <div>
                                      <div> Machine Learning & Geospatial Research</div>
                                      <div className="font-thin italic">(4-month Internship; 8-month part-time Research Assistant)</div>
                                    </div>
