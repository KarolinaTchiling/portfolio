...
const TorusKnot: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      const matKnot = new THREE.MeshStandardMaterial({ color: 0xffffff, roughness: 0.6, metalness: 0 });
    ...
    const animation = (time: number) => {
        if (meshKnot) {
          ...
          meshKnot.rotation.y += direction * 0.01;
          meshKnot.rotation.z += direction * 0.005;
        }
